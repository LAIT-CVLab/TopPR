...
#   Top P&R
###########################################
def top_pr(real_features, fake_features, multiplier = 5, alpha = 0.1, kernel = "cosine", random_proj = True, f1_score = True):
...
#   Outlier Detector
###########################################
def outlier_detector(features, multiplier, proj = 32, alpha = 0.1, kernel = "cosine"):
